...
openstack stack create --wait \
  ...
  -t ${WORK_DIR}/tools/gate/files/heat-public-net-deployment.yaml \
...
openstack stack create --wait \
  ...
  -t ${WORK_DIR}/tools/gate/files/heat-subnet-pool-deployment.yaml \
...
if helm ls --short | grep -q "^cinder$"; then
  ...
  openstack stack create --wait \
    ...
    -t ${WORK_DIR}/tools/gate/files/heat-vm-volume-attach.yaml \
